...
@LoadFeature(module = EOModules.ANVIL, description = "Changes the chance for anvils to degrade on use and allows repairing anvils with items in the experienceoverhaul:repairs_anvil item tag.")
public class AnvilDegradation extends Feature {

	public static final TagKey<Item> REPAIRS_ANVIL = TagKey.create(Registries.ITEM, ExperienceOverhaul.location("repairs_anvil"));
	...
	@Config(description = "If true, chipped and damaged anvils can be repaired by right-clicking with an item from the experienceoverhaul:repairs_anvil item tag (iron block by default)")
